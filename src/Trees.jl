...
# Redefinition of the show function that fires when the object is called
  ...
  mutable struct SuperNodeTree
    ...
    function SuperNodeTree(g::Graphs.Graph)
        ...
        snd, snptr, snd_par = Trees.findSuperNodes(par,child,post,degrees)
    ...
    function etree_liu(g::Graphs.Graph)
    ...
    function etree(g::Graphs.Graph)
        ...
        for i=1:N
            ...
            par_ = Trees.findParentDirect(g,i)
            par[i] = par_
        end
        return par
    end
    ...
    function findCliques(g::Graphs.Graph,snodes::Array{Int64,1},snptr::Array{Int64,1},supernode_par::Array{Int64,1},post::Array{Int64,1})
            ...
            for iii = 1:Nc
                ...
                adjPlus = Graphs.findHigherNeighborsSorted(g,vRep,postInv)
    ...
    function findParentDirect(g::Graphs.Graph,v::Int64)
          order = g.ordering[v]
